 ...
 * The hiker is situated in the top-left cell, (0, 0), and hopes to travel to the bottom-right cell, (rows-1, columns-1) (i.e.,0-indexed).
 * He can move up, down, left, or right. He wishes to find a route that requires the minimum effort.
